...
// ピクセルシェーダプログラム
// -------------------------------------------------------------
float4 PS_1(VS_OUTPUT In) : COLOR
{
    return float4(1.0f, 1.0f, 1.0f, 1.0f); // 赤色を返す
}
...
technique TShader
{
    ...
    {
        // シェーダ
        VertexShader = compile vs_2_0 VS_1(); // vs_1_1 -> ps_2_0
        PixelShader = compile ps_2_0 PS_1(); // ps_1_1 -> ps_2_0
    }
}
