...
HRESULT CMyD3DApplication::InitDeviceObjects()
{
	...
	else
	{
		...
		m_hmWLPB_ufo = m_pEffect->GetParameterByName(NULL, "mWLPB_ufo");
...
HRESULT CMyD3DApplication::FrameMove()
{
	...
	if (m_UserInput.bZoomIn && !m_UserInput.bZoomOut)
		m_fViewZoom += m_fElapsedTime * 1.5f;
...
void CMyD3DApplication::DrawUFO()
{
	...
	for (i = 0; i < m_pMesh->m_dwNumMaterials; i++) {
		...
		v.z = pMtrl->Diffuse.b;
		v.w = pMtrl->Diffuse.a;
		m_pEffect->SetVector(m_hvCol_ufo, &v);        // 頂点色
...
VOID CMyD3DApplication::DrawShadowGround()
{
	D3DXMATRIX m, mW;
...
VOID CMyD3DApplication::DrawGround()
{
	D3DXMATRIX m, mW;
	D3DXVECTOR3 vDir;
	D3DXVECTOR4 v;
